    ...
    <MainLayout>
      <div className="p-4 md:p-8 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">Gerenciar as configurações do sistema</p>
        </div>
        <div className="bg-nirart-card rounded-lg border border-gray-200 p-12 shadow-sm text-center">
          ...
          <p className="text-gray-600 text-sm mt-2">Volte mais tarde para acessar as configurações</p>
        </div>
      </div>
    </MainLayout>
  )
